...
export const navyUnits = [
  ...
  // ── FLEETS ────────────────────────────────────────────────────────────────
  {
    ...
    famousActions: [
      { battle: 'INS Vikramaditya (R33)', detail: 'Modified Kiev-class carrier (~45,000 tonnes), commissioned 16 November 2013 at Severodvinsk, Russia after refit at Sevmash; inducted by PM Modi on 14 June 2014. Operates MiG-29K/KUB + Ka-31 AEW + Ka-28 ASW helicopters. Based at INS Kadamba (Karwar). India signed an IGA for 26 Rafale Marine on 28 April 2025 — deliveries from ~2028.' },
    ...
    significance: 'Western Fleet = India\'s primary strike force in Arabian Sea. INS Vikramaditya enables power projection across Western IOR. Rafale Marine (26 jets ordered 28 April 2025 for ~₹63,000 crore / $7.5 billion) = next-gen carrier fighter. SSB: Carrier battle group = tri-service coordination at sea; one of the most complex joint operations.',
  },
  {
    ...
    famousActions: [
      { battle: 'INS Vikrant (R11) — First Indigenous Carrier', detail: 'India\'s first indigenously built aircraft carrier (~45,000 tonnes), commissioned 2 September 2022 at Kochi. Built at Cochin Shipyard with ~76% indigenous content. Currently operates MiG-29K (interim); Tejas Mk1N (naval LCA) under carrier compatibility trials. 26 Rafale Marine ordered 28 April 2025 as the permanent air wing.' },
  ...
  // ── NAVAL AVIATION ─────────────────────────────────────────────────────────
  {
    ...
    famousActions: [
      ...
      { battle: 'Rafale Marine — Future Air Wing', detail: '26 Rafale Marine fighters ordered from France under an IGA signed 28 April 2025 (~₹63,000 crore / $7.5 billion) for INS Vikrant\'s permanent air wing. Rafale Marine carries SCALP, METEOR, MICA and Exocet. Deliveries from ~2028, completing 2029–2031.' },
    ],
  ...
  {
    id: 'inas-312-albatross', name: 'INAS 312 "Albatross" (P-8I)', service: 'Navy', category: 'Naval Aviation',
    motto: 'Vigilance Beyond the Horizon',
    raised: 'Commissioned 18 November 1976 (Super Constellation); Tu-142M from 1988; transitioned to P-8I — first Indian P-8I formally inducted 13 November 2015 as 312-A',
    headquarters: 'INS Rajali, Arakkonam, Tamil Nadu',
    composition: '12 Boeing P-8I Poseidon (India variant) | 6 more approved (AoN granted) | 15 MQ-9B SeaGuardian UAVs on order for the Navy',
    ...
    famousActions: [
      ...
      { battle: 'Anti-Submarine Warfare — IOR', detail: 'P-8I tracks Chinese PLA Navy submarines in the Indian Ocean. India is a US Major Defence Partner, giving P-8I access to classified sonar databases under COMCASA. India detected and tracked Chinese submarine deployments through IOR chokepoints (Malacca, Hormuz, Lombok). 15 MQ-9B SeaGuardian armed UAVs ordered under the 15 Oct 2024 IGA — adds strike to maritime surveillance.' },
    ],
  ...
  // ── SUBMARINE ARM ──────────────────────────────────────────────────────────
  {
    ...
    famousActions: [
      ...
      { battle: 'Kalvari-class Programme (P75)', detail: '6 Project 75 Scorpène-based submarines built at Mazagon Dock, Mumbai (in collaboration with Naval Group, France): INS Kalvari (2017), Khanderi (2019), Karanj (2021), Vela (2021), Vagir (2023), Vagsheer (commissioned 15 January 2025). Air-independent propulsion (AIP) to be retrofitted at mid-life refit. P75I (6 more SSKs with AIP from Day-1) — next programme underway.' },
    ],
